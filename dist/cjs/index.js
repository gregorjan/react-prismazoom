...
var PrismaZoom = (0, react_1.forwardRef)(function (props, forwardedRef) {
    ...
    var lastRequestAnimationIdRef = (0, react_1.useRef)();
    // Last touch time in milliseconds
    var lastTouchTimeRef = (0, react_1.useRef)();
    // Last double tap time (used to limit multiple double tap) in milliseconds
    var lastDoubleTapTimeRef = (0, react_1.useRef)();
    // Last shifted position
    var lastShiftRef = (0, react_1.useRef)();
    // Last calculated distance between two fingers in pixels
    var lastTouchDistanceRef = (0, react_1.useRef)();
    // Last cursor position
    var lastCursorRef = (0, react_1.useRef)();
    // Last touch position
    var lastTouchRef = (0, react_1.useRef)();
    // Current zoom level
    var zoomRef = (0, react_1.useRef)(initialZoom);
    // Current position
    var posRef = (0, react_1.useRef)(defaultPos);
    // Current transition duration
    var transitionRef = (0, react_1.useRef)(animDuration);
    var _o = (0, react_1.useState)(defaultCursor), cursor = _o[0], setCursor = _o[1];
    var update = function () {
        if (!ref.current)
            return;
